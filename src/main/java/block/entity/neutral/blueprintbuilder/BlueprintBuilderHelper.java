...
public class BlueprintBuilderHelper {
	...
	public static ItemStack getOutput(int tech, int level) {
		...
		case 0: {
			switch (level) {
				case 0: return new ItemStack(FastBuildRegister.basiceclipsedorm_BLOCK_ITEM.get());
				case 1: return new ItemStack(FastBuildRegister.spheredoor_BLOCK_ITEM.get());
				case 2: return new ItemStack(FastBuildRegister.basicflatspheredorm_BLOCK_ITEM.get());
				case 3: return new ItemStack(FastBuildRegister.basiceclipsedorm_BLOCK_ITEM.get());
				case 4: return new ItemStack(FastBuildRegister.basicflatspheredorm_BLOCK_ITEM.get());
				case 5: return new ItemStack(FastBuildRegister.basiccylinderdorm_BLOCK_ITEM.get());
			}
		}	
		case 1:{
		}

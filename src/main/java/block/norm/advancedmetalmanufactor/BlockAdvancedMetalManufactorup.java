...
public class BlockAdvancedMetalManufactorup extends Block{
	public static String global_name = "advancedmetal_manufactor_up"; 
	
	public BlockAdvancedMetalManufactorup(Properties properties) {
		super(properties);
	}

...
public class BlockBioplasticBuilderup extends Block{
	public static String global_name = "bioplastic_builder_up"; 
	
	public BlockBioplasticBuilderup(Properties properties) {
		super(properties);
	}

...
public class TomatoBlock extends CropBlock {
	   ...
	   public static final MapCodec<TomatoBlock> CODEC = simpleCodec(TomatoBlock::new);
	   ...
	   public static final String global_name = "mar_tomato_block";

	   public MapCodec<TomatoBlock> codec() {
	      return CODEC;
	   }
	   

	   public TomatoBlock(BlockBehaviour.Properties p_51328_) {
	      super(p_51328_);
	   }

	   protected ItemLike getBaseSeedId() {
	      return ItemRegister.TOMATO.get();
	   }
	   ...
	   public VoxelShape getShape(BlockState p_51330_, BlockGetter p_51331_, BlockPos p_51332_, CollisionContext p_51333_) {
		...
		public InteractionResult use(BlockState blockstate,Level level,BlockPos pos,Player player,InteractionHand interactionhand,BlockHitResult blockHitResult) {
			...
			if(this.getAge(blockstate)==this.getMaxAge()) {
				...
				ItemStack outputItemStack = new ItemStack(ItemRegister.TOMATO.get(),output);

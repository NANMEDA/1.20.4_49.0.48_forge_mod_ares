...
public class BlockStoneWasherup extends Block{
	public static String global_name = "stone_washer_up"; 
	
	public BlockStoneWasherup(Properties properties) {
		super(properties);
	}
    ...
    public void onRemove(BlockState pState, Level pLevel, BlockPos pPos, BlockState pNewState, boolean pIsMoving) {
	 ...
	 static {
	        ...
	        BlockJSON.GenLootTableJSONBasic(global_name,BlockStoneWasher.global_name);
	 }
}

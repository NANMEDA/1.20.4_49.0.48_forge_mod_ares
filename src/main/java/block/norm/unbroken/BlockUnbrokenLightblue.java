...
public class BlockUnbrokenLightblue extends Block {
	
	public static final String global_name = "unbroken_decoration_lightblue";
	
	private BlockState white = null;
	private BlockState Green = null;
	
	public BlockUnbrokenLightblue(Properties p_49795_) {
		super(p_49795_
    ...
    public InteractionResult use(BlockState blockstate, Level level, BlockPos pos, Player player, InteractionHand interactionhand, BlockHitResult blockHitResult) {
        ...
        }else if(handItemStack.getItem()==Items.GREEN_DYE) {
        	deleteDye(rd, player, handItemStack);

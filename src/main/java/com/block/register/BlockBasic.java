...
public class BlockBasic {
    ...
    static {
        addBlock(0,"mar_surface",MapColor.COLOR_ORANGE,SoundType.SAND,dirt_strength,false,"shovel");
        addBlock(1,"mar_stone",MapColor.COLOR_RED,SoundType.STONE,stone_strength,true,"pickaxe");
        addBlock(2,"mar_deep_stone",MapColor.COLOR_RED,SoundType.STONE,ore_strength,true,"pickaxe");
        addBlock(3,"mar_iron_ore",MapColor.COLOR_LIGHT_GRAY,SoundType.STONE,ore_strength,true,"pickaxe");
        addBlock(4,"mar_deep_iron_ore",MapColor.COLOR_GRAY,SoundType.STONE,deep_ore_strength,true,"pickaxe");
        addBlock(5,"mar_gold_ore",MapColor.COLOR_LIGHT_GRAY,SoundType.STONE,ore_strength,true,"pickaxe");
        addBlock(6,"mar_deep_gold_ore",MapColor.COLOR_GRAY,SoundType.STONE,deep_ore_strength,true,"pickaxe");
        addBlock(7,"mar_copper_ore",MapColor.COLOR_ORANGE,SoundType.STONE,ore_strength,true,"pickaxe");
        addBlock(8,"mar_deep_copper_ore",MapColor.COLOR_ORANGE,SoundType.STONE,deep_ore_strength,true,"pickaxe");
        addBlock(9,"mar_deep_emerald_ore",MapColor.COLOR_GREEN,SoundType.STONE,deep_ore_strength,true,"pickaxe");    
    }
    
    static {
    	addBlock(10,"mar_deep_ominous_ore",MapColor.COLOR_BLACK,SoundType.STONE,new float[]{20.0F, 50.0F},true,"pickaxe");
    }
    
    public static int BLOCK_NUMBER = BLOCK_NAME.size();
    ...
    private static void addBlock(int id, String name, MapColor color, SoundType sound,float[] strength,Boolean tool,String tools) {

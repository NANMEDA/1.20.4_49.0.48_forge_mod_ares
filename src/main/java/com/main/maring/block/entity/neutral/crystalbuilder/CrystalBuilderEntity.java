package com.main.maring.block.entity.neutral.crystalbuilder;
...
public class CrystalBuilderEntity extends PowerConsumerEntity{
	...
	public CrystalBuilderEntity(BlockPos pos, BlockState pBlockState) {
		super(BlockEntityRegister.crystalbuilder_BLOCKENTITY.get(), pos, pBlockState);

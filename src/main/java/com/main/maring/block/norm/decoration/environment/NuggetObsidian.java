package com.main.maring.block.norm.decoration.environment;
...
public class NuggetObsidian extends Block{

	public static final IntegerProperty KIND = IntegerProperty.create("kind", 1, 16);
	public static final String global_name = "nugget_obsidian";
	
	public NuggetObsidian(Properties p_51021_) {
		super(p_51021_);
	}

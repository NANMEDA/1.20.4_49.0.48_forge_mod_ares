package com.main.maring.block.norm.etchingmachine;
...
public class BlockEtchingMachineup extends Block{
	public static String global_name = "etching_machine_up"; 
	
	public BlockEtchingMachineup(Properties properties) {
		super(properties);
	}

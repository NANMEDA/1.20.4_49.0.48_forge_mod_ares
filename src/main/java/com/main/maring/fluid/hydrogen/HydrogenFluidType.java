...
public class HydrogenFluidType {
    ...
    public static final ResourceLocation HYDROGEN_FLUID_OVERLAY_RL = new ResourceLocation(Maring.MODID, "misc/hydrogen_fluid");
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(FLUID_STILL_RL, FLUID_FLOWING_RL, HYDROGEN_FLUID_OVERLAY_RL,
                0xA0ADD8E6, new Vector3f(224f / 255f, 56f / 255f, 208f / 255f), properties));
    }

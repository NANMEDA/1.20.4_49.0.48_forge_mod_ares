...
public class ResearchTableScreent extends AbstractContainerScreen<ResearchTableMenu> {
    ...
    public ResearchTableScreent(ResearchTableMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
        if (useAlternateBackground) {
            ...
            ResearchTableScreenHelper.connection(guiGraphics, new int[]{this.leftPos,this.topPos}, new int[]{this.leftPos+this.imageWidth,this.topPos+this.imageHeight});
        } else {
        	this.imageWidth = 256;
            renderMainBackground(guiGraphics, partialTicks, mouseX, mouseY);
            ResearchTableScreenHelper.connection(guiGraphics, new int[]{this.leftPos+this.imageWidth,this.topPos}, new int[]{this.leftPos,this.topPos+this.imageHeight});
        }
    }

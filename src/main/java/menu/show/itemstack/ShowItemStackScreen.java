...
public class ShowItemStackScreen extends AbstractContainerScreen<ShowItemStackMenu> {
    ...
    public ShowItemStackScreen(ShowItemStackMenu pMenu, Inventory pInventory, Component pComponent) {
    ...
    private void render3DModel(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        Minecraft.getInstance().getItemRenderer().renderStatic(this.getMenu().getItemStack(), ItemDisplayContext.FIXED, 0xF000F0, OverlayTexture.NO_OVERLAY, poseStack, Minecraft.getInstance().renderBuffers().bufferSource(), Minecraft.getInstance().level, 0);

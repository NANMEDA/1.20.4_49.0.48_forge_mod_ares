...
public class TechManager {
    ...
    public static void initiateTech() {
        ...
        TechNode calculus = new TechNode("calculus", null,null);
        TechNode linear_algebra = new TechNode("linear_algebra", null,null);
        TechNode mathematical_statistics = new TechNode("mathematical_statistics", null,null);
        TechNode basic_astronomy = new TechNode("basic_astronomy", null,null);
        TechNode herbs = new TechNode("herbs", null,null);
        
        TechNode modular_building = new TechNode("modular_building", null,false,1,null);
        TechNode classical_control_theory = new TechNode("classical_control_theory", null,false,1,null);
        TechNode classical_physics = new TechNode("classical_physics", null,false,1,null);
        TechNode classical_chemistry = new TechNode("classical_chemistry", null,false,1,null);
        TechNode basic_biology = new TechNode("basic_biology", null,false,1,null);
        ...
        TechNode modern_control_theory = new TechNode("modern_control_theory", null,false,2,null);
        TechNode astronomy = new TechNode("astronomy", null,false,2,null);
        TechNode steam_engine = new TechNode("steam_engine", null,false,2,null);
        TechNode biology = new TechNode("biology", null,false,2,null);
        TechNode dome = new TechNode("dome", null,false,2,null);
        ...
        TechNode theory_of_relativity = new TechNode("theory_of_relativity", null,false,3,null);
        TechNode the_quantum_theory = new TechNode("the_quantum_theory", null,false,3,null);
        TechNode electricity = new TechNode("electricity", null,false,3,null);
        TechNode diesels = new TechNode("diesels", null,false,3,null);
        TechNode environmental_theory = new TechNode("environmental_theory", null,false,3,null);
        ...
        TechNode modern_astronomy = new TechNode("modern_astronomy", null,false,4,null);
        TechNode environment_detection = new TechNode("environment_detection", null,false,4,null);
        TechNode nuclear_reaction = new TechNode("nuclear_reaction", null,false,4,null);
        TechNode laser = new TechNode("laser", null,false,4,null);
        TechNode electric_motor = new TechNode("electric_motor", null,false,4,null);
        TechNode silicon = new TechNode("silicon", null,false,4,null);
        TechNode aerospace = new TechNode("aerospace", null,false,4,null);
        TechNode propulsion = new TechNode("propulsion", null,false,4,null);
        ...
        TechNode rocket = new TechNode("rocket", null,false,5,null);
        TechNode basic_robot = new TechNode("basic_robot", null,false,5,null);
        TechNode terraforming = new TechNode("terraforming", null,false,5,null);
        TechNode M_theory = new TechNode("M_theory", null,false,5,null);
        TechNode advance_laser = new TechNode("advance_laser", null,false,5,null);
        TechNode quark = new TechNode("quark", null,false,5,null);
        TechNode chip = new TechNode("chip", null,false,5,null);
        ...
        TechNode stellar_station = new TechNode("stellar_station", null,false,6,null);
        TechNode antimatter = new TechNode("antimatter", null,false,6,null);
        TechNode asteroid_rope = new TechNode("asteroid_rope", null,false,6,null);
        TechNode robot = new TechNode("robot", null,false,6,null);
        TechNode gravitational_wave = new TechNode("gravitational_wave", null,false,6,null);
    ...
    private ResourceLocation gen(String name) {
